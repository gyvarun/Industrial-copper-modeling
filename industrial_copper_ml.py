        ...
        with st.form('Regression'):
            ...
            with col1:
                ...
                item_date = st.date_input(label='Item Date', min_value=date(2020,1,1), 
                                        max_value=date(2024,12,31), value=date(2024,7,1))
            ...
            with col3:
                ...
                delivery_date = st.date_input(label='Delivery Date', min_value=date(2020,2,1), 
                                            max_value=date(2024,12,31), value=date(2020,8,1))
    ...
    def classification():
        ...
        with st.form('Classification'):
            ...
            with col1:
                ...
                item_date = st.date_input(label='Item Date', min_value=date(2020,1,1), 
                                            max_value=date(2024,12,31), value=date(2020,9,1))
            ...
            with col3:
                ...
                delivery_date = st.date_input(label='Delivery Date', min_value=date(2020,2,1), 
                                            max_value=date(2024,12,31), value=date(2020,10,1))
